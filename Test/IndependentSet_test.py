...
from Test.dd_controlled_generators import DDIndependentSet, ReduceDDIndependentSet
import io
import os
...
class ProblemIndependentSetTest(unittest.TestCase):
    ...
    def test_objective_result_solution(self):
        dd_independent_set_instance = DD(self.independent_set_instance, v=False)
        objective_function_instance = ObjectiveFunction(dd_independent_set_instance.graph_DD)
    ...
    def test_objective_result_route(self):
        ...
        self.assertEqual(result, "(0, 0) -> ('1', 0) -> ('3', 0) -> ('6', 0) -> ('8', 0) -> ('10', 0)")

class ProblemReducedIndependentSetTest(unittest.TestCase):
    def setUp(self):
        class ProblemIndependentSet(AbstractProblem):
